  ...
  data() {
    return {
      ...
      softwares: [
        ...
        { id: 5,  name: "MiConvertImage", category: "Utilitários", description: "Converta imagens em webp, jpg e png.", link: "https://github.com/mugomes/miconvertimage" },
        ...
        { id: 7,  name: "MiCheckExif", category: "Utilitários", description: "Visualize e remova dados EXIF de imagens.", link: "https://github.com/mugomes/micheckexif" },
